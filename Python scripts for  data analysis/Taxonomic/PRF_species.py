...
def calculate_metrics(df):
    ...
    for genus in genera:
        tp = df.loc[df["Category"] == f"E_{genus}", "Count"].values[0]
        fp = df.loc[df["Category"] == f"C_{genus}", "Count"].values[0] - df.loc[df["Category"] == f"E_{genus}", "Count"].values[0]
        fn = df.loc[df["Category"] == f"A_{genus}", "Count"].values[0] - df.loc[df["Category"] == f"E_{genus}", "Count"].values[0]
